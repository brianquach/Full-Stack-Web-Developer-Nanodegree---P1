...
def get_movie_list():
	"""Fetches a list of movie objects that are initialized by hard coded values.

	Returns:
		A list of movie objects; each movie object represents one of my favorite movies with relevant movie data.
	"""
	...
	return [shawshank, batman, toy_story_2, spirited_away, goodfellas, conjuring, rush_hour_2, indie_gamer, goonies];
